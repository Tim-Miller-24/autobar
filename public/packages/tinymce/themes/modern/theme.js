        ...
        function repaintScroll() {
          ...
          function repaintAxis(axisName, posName, sizeName, contentSizeName, hasScroll, ax) {
            ...
            if (scrollBarElm) {
              ...
              containerSize = containerElm['client.css' + sizeName] - margin * 2;
              containerSize -= hasScrollH && hasScrollV ? scrollBarElm['client.css' + ax] : 0;
          ...
          function addScrollAxis(axisName, posName, sizeName, deltaPosName, ax) {
            ...
            self.draghelper = new DragHelper(axisId + 't', {
              ...
              drag: function (e) {
                ...
                containerSize = self.getEl('body')['client.css' + sizeName] - margin * 2;
                containerSize -= hasScrollH && hasScrollV ? self.getEl('scroll' + axisName)['client.css' + ax] : 0;
