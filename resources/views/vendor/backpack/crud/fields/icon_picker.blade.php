...
@php
    ...
    switch ($field['iconset']) {
        ...
        case 'meterialdesign':
            ...
            break;
        default:
            $fontIconFilePath = asset('packages/bootstrap-iconpicker/icon-fonts/fontawesome-5.15.1/css/all.min.css');
            break;
    }
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_scripts')
        <!-- Bootstrap-Iconpicker -->
        <script type="text/javascript" src="{{ asset('packages/bootstrap-iconpicker/bootstrap-iconpicker/js/bootstrap-iconpicker.bundle.min.js?v=1.2') }}"></script>
