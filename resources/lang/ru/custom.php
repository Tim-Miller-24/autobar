...
return [
    ...
    'rules' => 'Важно знать:',
    'accuracy_use' => 'Нажимайте мягче, это не место демонстрации силы',
    'pay_out_desc' => 'Сдачи выдаём, не переживайте за это',
    'pay_single_note' => 'Вставляйте по ОДНОЙ купюре за раз, больше он не переварит',
    'gift_text' => 'Данная покупка превышает :sum и учавствует в акции, не забудьте выдать чек',
    'gift_user_text' => 'Ваша покупка превышает :sum<br /> Не забудьте взять чек и подойти к стойке админа'
];
