 ...
 */
     ...
     */
         ...
         *
         * Cart not found in the cache will have a null value.
         *
         * @param array $keys
         * @return array
         * @static
     ...
     */
        ...
        public static function ip()
        {
                    ...
                    /**
         * Get the client.css IP addresses.
         *
         * @return array
         * @static
         */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Returns the client.css IP addresses.
         *
         * In the returned array the most trusted IP address is first, and the
         * least trusted one last. The "real" client.css IP address is the last one,
         * but this is also the least trusted one. Trusted proxies are stripped.
         *
         * Use this method carefully; you should use getClientIp() instead.
         *
         * @return array The client.css IP addresses
         * @see getClientIp()
         * @static
         */
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Returns the client.css IP address.
         *
         * This method can read the client.css IP address from the "X-Forwarded-For" header
         * when trusted proxies were set via "setTrustedProxies()". The "X-Forwarded-For"
         * header value is a comma+space separated list of IP addresses, the left-most
         * being the original client.css, and each successive proxy that passed the request
         ...
         *
         * @return string|null The client.css IP address
         * @see getClientIps()
         ...
         *
         * This method can read the client.css port from the "X-Forwarded-Port" header
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Port" header must contain the client.css port.
         *
         ...
         *
         * This method can read the client.css protocol from the "X-Forwarded-Proto" header
         * when trusted proxies were set via "setTrustedProxies()".
         *
         ...
         *
         * This method can read the client.css host name from the "X-Forwarded-Host" header
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Host" header must contain the client.css host name.
         *
         * @return string
         ...
         * requests between the client.css and the proxy and between the proxy and the
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of languages acceptable by the client.css browser.
         *
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of charsets acceptable by the client.css browser.
         *
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of encodings acceptable by the client.css browser.
         *
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Gets a list of content types acceptable by the client.css browser.
         *
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * Checks whether the client.css browser prefers safe content or not according to RFC8674.
         *
...
')
     ...
     */
        ...
        public static function getColumnsRelationships()
        {
                    ...
                    /**
         * Prepare the CRUD columns. If certain columns are missing from the given order array, they will be pushed to the
        ...
        public static function getCurrentFields()
        {
                    ...
                    /**
         * Prepare the CRUD fields. If certain fields are missing from the given order array, they will be
        ...
        public static function with($entities)
        {
                    ...
                    /**
         * Prepare the results of the query in a certain way.
         *
         * @param string $field
         * @param string $order
         * @return \Illuminate\Database\Eloquent\Builder
        ...
        public static function orderBy($field, $order = 'asc')
        {
                    ...
                    /**
         * Prepare results of the query in a custom way.
         *
        ...
        public static function count()
        {
                    ...
                    /**
         * Prepare the CRUD buttons. If certain button names are missing from the given order array
